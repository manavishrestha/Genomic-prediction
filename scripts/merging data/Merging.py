...
#Save to csv
Env_geno_blues_meta_weather.to_csv("/Users/manavi/Desktop/Code drafts/Final_merged_yield.csv", index = False)


# Merging for plant height
#Download the BLUE for plant height obtained from BLUEs.py
#Repeat the same code as above
#save the merged file as Final_merged_plant_height.csv
